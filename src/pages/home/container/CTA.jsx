    ...
    return (
      ...
      <section className="relative bg-dark-hard px-5">
        ...
        <div className="col-span-12 lg:col-span-6">
            ...
            <p className="text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left"><span className="font-bold italic text-[#B3BAC5] md:not-italic md:font-normal md:text-dark-light">Get a response tommorrow</span> if you submit by 9pm today. If we recieved after 9pm will get a response the following day.</p>
        </div>
        <div className="col-span-12 hidden mb-[70px] md:block md:order-first lg:cols-span-6 lg:order-last">
          <div className="w-3/4 mx-auto relative">
          <div className="w-1/2 h-1/2 bg-[#FC5A5A] rounded-lg absolute top-[10%] -right-[8%] "/>
          <div className="w-1/2 h-1/2 bg-white rounded-lg opacity-[0.6] absolute bottom-[10%] -left-[8%] "/>
          <div className="w-full bg-white p-3 z-[1] relative rounded-xl">
            ...
            <div className='p-5'>
                <h2 className='font-roboto font-bold text-xl text-dark-soft lg:text-[28px]'>Future of Work</h2>
